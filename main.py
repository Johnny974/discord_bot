...
@bot.event
async def on_ready():
    await bot.change_presence(activity=discord.Game(name="/commands | /randomverse | /nasa | /vtip | /ovocko | /ovocko_highscore | /anketa "
...
async def commands(ctx):
    embed = discord.Embed(title="Dostupné príkazy:", description="/randomverse \n/nasa \n/vtip \n/anketa <otázka>-<možnosť1>-<možnosť2>-... "
                                                                 "\n/ovocko \n/ovocko_highscore",
